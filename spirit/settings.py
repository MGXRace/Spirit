...
from spirit.themes import THEME_DICT
import os
...
TEMPLATE_DIRS = ()
STATICFILES_DIRS = ()
for theme_name, theme in THEME_DICT.items():
    TEMPLATE_DIRS += (theme.template_dir,)
    STATICFILES_DIRS += (('spirit/themes/{}'.format(theme_name), theme.static_dir),)
    COMPRESS_PRECOMPILERS += theme.compress_precompilers
